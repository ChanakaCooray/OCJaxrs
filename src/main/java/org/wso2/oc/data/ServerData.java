...
public class ServerData {
	...
	public String print(){;
		String data= this.ip+" : "+this.serverName+" :"+this.serverVersion+":"+this.domain+":" +this.subDomain+":"+this.adminServiceUrl+":"+this.startTime+":"+this.os+":"+this.totalMemory+":"+this.cpuCount+":"+this.cpuSpeed+":"+this.timestamp+":"+this.idleCpuUsage+":"+this.systemCpuUsage+":"+this.userCpuUsage+":"+this.serverUpTime+":"+this.threadCount+":"+this.systemLoadAverage+":"+this.printData(this.patches);
		return data;
	}
